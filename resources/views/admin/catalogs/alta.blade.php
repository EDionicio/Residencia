          ...
          @if (auth()->user()->inventario === 1)
            <li class="active">
              ...
              <ul class="submenu-active" id="submenu-list" >
                <li class="activo"><a href="{{url('admin/catalogo')}}"><i class="fa fa-list"></i>Catálogo</a><small class="bg-indicator">Registrar</small></li>
                <li><a href="{{url('admin/inventary')}}"><i class="fa fa-list"></i>Entrada Productos</a></li>
